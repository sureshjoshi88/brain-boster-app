const questions = {
 ...
 hindiLiterature :{
  easy: [
    {
      question: "गोदान उपन्यास किसके द्वारा लिखा गया है?",
      options: ["मुंशी प्रेमचंद", "सूरदास", "महादेवी वर्मा", "रामधारी सिंह दिनकर"],
      answer: "मुंशी प्रेमचंद",
    },
    {
      question: "‘गीतांजलि’ कृति के रचयिता कौन हैं?",
      options: ["जयशंकर प्रसाद", "रामधारी सिंह दिनकर", "रवीन्द्रनाथ ठाकुर", "हरिवंश राय बच्चन"],
      answer: "रवीन्द्रनाथ ठाकुर",
    },
    {
      question: "किस कवि को ‘आदि कवि’ कहा जाता है?",
      options: ["तुलसीदास", "वाल्मीकि", "सूरदास", "कबीर"],
      answer: "वाल्मीकि",
    },
  ],
  medium: [
    {
      question: "‘कामायनी’ महाकाव्य किस कवि की रचना है?",
      options: ["सुमित्रानंदन पंत", "जयशंकर प्रसाद", "रामधारी सिंह दिनकर", "हरिवंश राय बच्चन"],
      answer: "जयशंकर प्रसाद",
    },
    {
      question: "‘मधुशाला’ काव्य-संग्रह के कवि कौन हैं?",
      options: ["रामधारी सिंह दिनकर", "हरिवंश राय बच्चन", "सूरदास", "मैथिलीशरण गुप्त"],
      answer: "हरिवंश राय बच्चन",
    },
    {
      question: "‘साकेत’ नामक काव्य किस कवि की रचना है?",
      options: ["मैथिलीशरण गुप्त", "रामधारी सिंह दिनकर", "सूरदास", "जयशंकर प्रसाद"],
      answer: "मैथिलीशरण गुप्त",
    },
  ],
  hard: [
    {
      question: "‘उर्वशी’ कृति के लिए किस कवि को ज्ञानपीठ पुरस्कार मिला था?",
      options: ["रामधारी सिंह दिनकर", "हरिवंश राय बच्चन", "महादेवी वर्मा", "मैथिलीशरण गुप्त"],
      answer: "रामधारी सिंह दिनकर",
    },
    {
      question: "‘अंधायुग’ नामक नाटक किस साहित्यकार की रचना है?",
      options: ["धर्मवीर भारती", "मोहन राकेश", "जयशंकर प्रसाद", "हरिवंश राय बच्चन"],
      answer: "धर्मवीर भारती",
    },
    {
      question: "‘प्रेमाश्रम’ उपन्यास किसके द्वारा लिखा गया है?",
      options: ["मुंशी प्रेमचंद", "भारतेन्दु हरिश्चंद्र", "सूरदास", "जयशंकर प्रसाद"],
      answer: "मुंशी प्रेमचंद",
    },
  ],
}
